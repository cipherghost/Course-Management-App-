  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      ...
      <li class="nav-item active">
        <a class="nav-link"  href="#" >Course 3 <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<div id="home3" style="display:block;">
...
echo '
<table class="table table-hover table-dark" id="myTableId3">
  <thead>
    <tr>
      <th scope="col">#</th>
  ...
  <tbody> ';
   while ($row = $result->fetch_assoc()) { echo'
    <tr>
      ...
      <td> 
        <a href="upload/' . $row['dname'] . '.pdf" download onclick="Countfun(2,this)" > 
