  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      ...
      <li class="nav-item active" >
        <a class="nav-link"  href="#" >Course 2 <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item ">
...
<div class="modal fade" id="eModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
     ...
     <button type="submit" name="submit" class="btn btn-success" onclick="addRow()">Upload</button>
...
<!--Table starts here -->
   ...
   <!--  Course 2 Table -->
<div id="home2" style="display:block;">
...
echo '
<table class="table table-hover table-dark" id="myTableId2">
  <thead>
    <tr>
      <th scope="col">#</th>
  ...
  <tbody> ';
   while ($row = $result->fetch_assoc()) { echo'
    <tr>
      ...
      <td> 
        <a href="upload/' . $row['dname'] . '.pdf" download onclick="Countfun(1,this)" > 
