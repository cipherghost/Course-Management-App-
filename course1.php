  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto ">
      <li class="nav-item active" >
        <a class="nav-link " href="#" >Course 1 <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item " >
      ...
      <li class="nav-item">
        <a class="nav-link"  href="course4.php" >Course 4 <span class="sr-only">(current)</span></a>
      </li>
    </ul>
</div>
...
<div class="dropdown dp1">
 ...
 COURSE 1
  ...
  <div class="dropdown-menu dropdown-menu-center" aria-labelledby="dropdownMenu2">
    ...
    <a class="dropdown-item" type="button" href="course4.php" >COURSE 4</a>
  </div>
</div>
<!-- Dropdown ends here -->
...
<a> <img src="images/users.png" width="30" height="30" ></a>
  <!-- Add file icon -->
  <a  data-toggle="modal" data-target="#eModal" id="addition" title="Add file">
   <img src="images/plus.png" width="30" height="30" class="mx-5" >
  </a>

  <!-- Leaderboard icon -->
  <a onclick="openRightMenu()" title="leaderboard" id="hamburger">
    <img src="images/icons8-menu-40.png" width="30" height="30" >
  </a>
...
<!-- leaderboard content starts here -->
 ...
 <div class="sidebar-right"  style="right:0;" id="rightMenu">

<a onclick="closeRightMenu()" title="leaderboard" id="closing" style="margin-right: 10px; float:right;padding-top:20px;
  margin-bottom:10px;">
  <img src="images/close2.png" width="20" height="20">
  </a>

  <h4 id="lb" ><img src="images/gem.png" width="30" height="30">Top Gems</h4>
  
    
  <table class="top-gem" id="topgems">
...
echo '
<table class="table table-hover table-dark" id="myTableId1">
  <thead>
    <tr>
      <th scope="col">#</th>
   ...
   while ($row = $result->fetch_assoc()) { echo'
    <tr>
      ...
      <td><span ><div style="float:left;"><img src="images/file.png"  width="50" height="50"></div>' . $row['dname'] . '<div>' . $row['date'] . '</div></span></td> 
           <td> ' . $row['nod'] . ' </td>
     <td>
      <a href="upload/' . $row['dname'] . '.pdf" download onclick="Countfun(0,this)" > 
        <img src="images/downloadw.png" width="50" height="50"> 
        <a> 
      </td>
      <td> <span><div style="float:left;"><a> <img src="images/edit.png" width="30" height="30" style="margin-right:15px;" title="edit"></a></div><a><img src="images/delete.png" width="30" height="30" title="delete"></a></span>
</td>    
</tr>
       ';
